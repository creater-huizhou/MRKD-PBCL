...
class DeepLabV3(nn.Module):
    def __init__(self, output_stride=16, norm_act='bn_sync', backbone_pretrained=False,
        classes=None, use_cosine=False, freeze_all_bn=False, freeze_backbone_bn=False):
        super().__init__()
    ...
    def forward(self, x, ret_intermediate=False):
        ...
        sem_logits = F.interpolate(sem_logits_small, size=out_size, mode="bilinear", align_corners=False)
