...
from trainer.trainer_voc import Trainer_Segformer_base, Trainer_Segformer_incremental
...
if __name__ == '__main__':
    ...
    options = [
        CustomArgs(['--multiprocessing_distributed'], action='store_false', target='multiprocessing_distributed'),
